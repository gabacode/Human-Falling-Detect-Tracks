...
class_names = ["Standing", "Walking", "Sitting", "Lying Down", "Stand up", "Sit down", "Fall Down"]  # label.
...
while True:
    ...
    if ret:
        ...
        frame = cv2.putText(
            frame, "Frame: {} Pose: {}".format(i + 1, cls_name), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2
        )
