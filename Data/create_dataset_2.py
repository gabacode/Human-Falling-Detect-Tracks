...
for vid in vid_list:
    ...
    if os.path.exists(annot_file):
        annot = pd.read_csv(annot_file, header=None, names=["frame_idx", "class", "xmin", "ymin", "xmax", "ymax"])
    ...
    while True:
        ...
        if ret:
            ...
            result = []
            if bb.any() != 0:
                result = pose_estimator.predict(frame, torch.tensor(bb[None, ...]), torch.tensor([[1.0]]))
